...
export const Item =({
    ...
    return(
        ...
        className={cn("group min-h-[27px] text-sm py-1 pr-3 w-full flex items-center text-muted-foreground font-medium",
            active&&"bg-primary/5 text-primary", button&&"hover:bg-primary/5"
        )}>
            {!!id&&(
